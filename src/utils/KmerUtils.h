...
namespace KmerUtils {
    ...
    static inline uint64_t BaseToInt(char &base) {
        switch(base) {
            case 'A':
                return (0);
            case 'C':
    ...
    static inline uint64_t BaseToIntC(char &base) {
        switch(base) {
            case 'A':
                return (3);
            case 'C':
    ...
    static inline uint64_t BaseToInt(char &base, int replace_n) {
        switch(base) {
            case 'A':
                return (0);
            case 'C':
    ...
    static inline uint64_t BaseToIntC(char &base, int replace_n) {
        switch(base) {
            case 'A':
                return (3);
            case 'C':
...
//        for (int i = bits/2 - 1; i >= 0; i--) {
    ...
    static std::string reverseComplement(string forward) {
        std::string reverse = "";
